  ...
  const removeBackground = async () => {
    ...
    const analyzeImage = async (metadata: AnalysisMetadata) => {
         ...
         try {
             ...
             formData.append('total_seeds_germinated', metadata.totalSeedsGerminated.toString());
             formData.append('germination_percentage', metadata.germinationPercentage.toString());
                                        ...
                                        <View style={styles.sviSection}>
                                            ...
                                            <View style={styles.valuesGrid}>
                                                <View style={styles.valueCard}>
                                                    <Text style={styles.valueLabel}>Total Seeds Kept</Text>
                                                    <Text style={styles.valueNumber}>{calculateSVI()?.totalSeedsKept}</Text>
                                                </View>
                                                <View style={styles.valueCard}>
                                                    <Text style={styles.valueLabel}>Germinated</Text>
                                                    <Text style={styles.valueNumber}>{calculateSVI()?.totalSeedsGerminated}</Text>
                                                </View>
                                                <View style={styles.valueCard}>
                                            ...
                                            <View style={styles.calculationBox}>
                                                ...
                                                <Text style={styles.calcStep}>Germination % = ({calculateSVI()?.totalSeedsGerminated} / {calculateSVI()?.totalSeedsKept}) × 100 = <Text style={styles.calcValue}>{calculateSVI()?.germinationPercentage}%</Text></Text>
